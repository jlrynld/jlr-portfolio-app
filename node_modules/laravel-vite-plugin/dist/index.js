...
function laravel(config) {
    ...
    return {
        ...
        renderChunk(_, chunk) {
            ...
            const relativeChunkPath = path_1.default.relative(resolvedConfig.root, chunk.facadeModuleId);
        ...
        writeBundle() {
            const manifestPath = path_1.default.resolve(resolvedConfig.root, resolvedConfig.build.outDir, 'manifest.json');
...
function resolvePluginConfig(config) {
    ...
    return {
        input: (_a = config.input) !== null && _a !== void 0 ? _a : ['resources/css/app.css', 'resources/js/app.js'],
